...
function ActionCell({
  ...
  return (
    <div className="flex justify-center">
      <Button
        onClick={() => router.push(`/admin/surat/verifikasi/${slug}`)}
        size="sm"
...
export const verifikasiAdminColumns: ColumnDef<LetterRequest>[] = [
  {
  ...
  },
  {
    ...
    header: "Status",
    cell: ({ row }) => {
      const presentation = getRequestStatusPresentation(row.original, "ADMIN");
      return (
