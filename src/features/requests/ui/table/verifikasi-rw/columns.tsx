...
function ActionCell({
  ...
  return (
    <div className="flex justify-center">
      <Button
        onClick={() => router.push(`/rw/surat/verifikasi/${slug}`)}
        size="sm"
...
export const verifikasiRWColumns: ColumnDef<LetterRequest>[] = [
  {
  ...
  },
  {
    ...
    header: "Status",
    cell: ({ row }) => {
      const presentation = getRequestStatusPresentation(row.original, "RW");
      return (
